...
(function($) {
	...
	$.J.DrawCalendar = function(dateIn){
		...
		for (var i = 0; i < _totalBoxes; i++) {
			...
			//DateBox Events
			var dateLink = $('<div class="DateLabel"><a href="#" onclick="calendar('+(currentDate.getYear()+1900)+','+(currentDate.getMonth()+1)+','+currentDate.getDate()+')">' + currentDate.getDate() + '</a></div>');
			//var dateLink = $('<div class="DateLabel"><a href="#" onclick="calendar((currentDate.getYear()+1900),(currentDate.getMonth()+1),currentDate.getDate())">' + currentDate.getDate() + '</a></div>');
