...
a:link		{text-decoration:none;}
	...
	a:hover	{text-decoration:none;color:#68A4C4;}
	a:active	{text-decoration:none;color:#68A4C4;}
...
<body style="overflow-x:hidden; overflow-y:auto;">
	...
	<div id="wrapper">
		...
		<section class="callaction" style="background-color: white;">
			<div class="container" style="width : 100%; padding-left: 0px;padding-right: 0px; margin-left: 0px; margin-right: 0px;">
				<div class="row">
					<div class="col-lg-12" style="width : 100%; padding-right: 0px;padding-left: 0px;">
						<div class="big-cta">
							<div class="cta-text">
								<img src="resources/main/img/slides/cat.jpg"
