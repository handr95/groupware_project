...
<body>
	<div id="wrapper">
		...
		<section class="callaction" style="background-color: white;  padding-top: 30px">
			<div class="container" style="min-width: 500px; padding-bottom: 30px">
				<div class="row">
					<div class="col-lg-12">
						<div class="big-cta">
							<div id="center">${errorReportform}</div>
						</div>
					</div>
				</div>
			</div>
