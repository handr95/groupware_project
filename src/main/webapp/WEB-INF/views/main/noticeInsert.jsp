...
<script type="text/javascript">
	...
	function noticecheck() {
		var nt_Title = document.getElementsByName("nt_Title")[0];
		var nt_content = document.getElementsByName("nt_content")[0];
		if (nt_Title.value == "") {
			alert("제목을 입력해주세요");
			nt_Title.focus();
			return false;
		} else if (nt_content.value == "") {
			alert("내용을 입력해주세요");
			nt_content.focus();
			return false;
		}
				...
				<section id="content">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									<div id="noticeform">${noticeInsert}</div>
									<div class="col-lg-3">
