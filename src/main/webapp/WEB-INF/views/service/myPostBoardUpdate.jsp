...
<body>
	...
	<div id="wrapper">
		...
		<!-- end header -->
		<section id="content"
			style="padding-top: 80px; padding-left: 140px; padding-bottom: 0px;">
			<div id="templatemo">
				<p>
				...
				<section id="content" style="padding-top: 0px">
					...
					<div class="container"
						style="padding-left: 0px; padding-right: 0px; margin-left: 15px; margin-right: 10px">
						<div class="row">
							<div class="col-lg-12">
								<div class="row">

									<ul class="portfolio-categ filter"
										style="width: 1080px; padding-left: 20px; padding-right: 40px; padding-top: -30px;">
										${myboardpostUpdateForm}
									</ul>
