      ...
      <section id="content" style="padding-top: 50px; padding-left: 140px;">
         <div id="templatemo">
            ...
            <div class="container-fluid" style="padding-left: 10px;">
               ...
               <div class="row"></div>
               <div class="row"
                  style="width: 1080px; height: 40px; padding-right: 110px;">


                  <div class="item-thumbs col-lg-3 design" data-id="id-0"
                     data-type="web" style="width: 970px">
                     서비스 해지에 앞서 아래 사항을 반드시 확인하세요. <br>서비스 해지를 요청하는 즉시 가입한 이메일이
                     해지되며 회원으로서의 권한이 삭제됩니다. <br>서비스 해지 후 1개월 동안 동일한 이메일로 다시 가입할 수
                     없으며, 이 기간내에 고객센터를 통하여 복구를 신청하시면 다시 서비스를 사용하실 수 있습니다. <br>서비스
                     해지 후에는 서비스에 저장된 개인정보는 모두 삭제되지만, 본인이 작성한 자료 중에서 팀에 등록한 업무에 관련된 자료
                     (업무,보고서,프로젝트,자료실 등)는 해당 팀이 폐쇄되기 전까지 남아 있습니다. <br>팀의 마스터인 경우
                     소유하고 있는 모든 팀의 마스터 권한을 위임하거나 팀을 폐쇄해야만 해지가 가능합니다.
                  </div>
               </div>
      </section>
                  ...
                  <section id="projects">
                     <ul id="thumbs" class="portfolio">
                        ...
                        <li class="item-thumbs col-lg-3 design" data-id="id-0"
                           data-type="web"
                           style="padding-left: 530px; padding-bottom: 150px; padding-right: 680px">
                           <form action="/memberDrop">
                              <input type="submit" value="탈퇴" style="left: 50px">
                           </form> <!-- Fancybox - Gallery Enabled - Title - Full Image --> <!-- Thumb Image and Description -->
                        </li>
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
