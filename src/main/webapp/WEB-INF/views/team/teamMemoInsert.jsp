...
/*   	  	.open {display:block;color:green} */
	...
	#memoupdate { position:absolute;top:25%;left:40%;
...
<script type="text/javascript">
	function memoupdateform(code){//	
		 $('#articleView_layer').addClass('open');
		 $.ajax({ type:'get',
			   url:'memoUpdateForm',
			   data: ({tmm_CODE:code }),
			   success:function(data){
				 $('#memoupdate').html(data);				 
			}		
		});
	}
...
<!-- <script src="http://code.jquery.com/jquery-1.11.0.min.js"></script> -->
<script type="text/javascript">
function memoinsert(code) 
{ 	
	$.ajax({ type:'get',
		   url:'memoInsert',
		   data: ({tmm_CODE:code
			   	  ,tmm_CONTENT:$('#commentParentText').val()
		   		  ,tmh_CODE:$('#tmh_CODE').val()}),
		   success:function(data){
			 $('#memo').html(data);
...
function memoupdate(code) 
{
	$.ajax({ type:'get',
		   url:'memoUpdate',
		   data: ({tmm_CODE:code
			   	  ,tmm_CONTENT:$('#newmemo').val()
		   		  ,tmh_CODE:$('#tmh_CODE').val()}),
		   success:function(data){
			 $('#memo').html(data);
	...
	<div id="main-sidebar" class="hidden-xs hidden-sm">
		...
		<div class="navigation">
	        <ul class="main-menu">
	            <li class="home"><a href="/team_homeform">홈</a></li>
	            <li class="about"><a href=" /projectform">프로젝트</a></li>	             
	            <li class="services"><a href="/bworkform">업무</a>	            
	            <li class="portfolio"><a href="/boardForm">게시판</a></li>
	            <li class="contact"><a href="/memoform">메모</a></li>
	        	<li class="contact2"><a href="/calendarform">캘린더</a></li>	
	        	<li class="contact3"><a href="/messageSendform">쪽지</a></li>
				                            ...
				                            <tr>
				                                <td>
				                                    <span style='float:right'>
				                                        ...
				                                        <button type="button" class="btn btn-default" onclick="memoinsert()">메모쓰기</button>
				                                    </span>
				                                </td>
				                            </tr>
				                        </thead>
