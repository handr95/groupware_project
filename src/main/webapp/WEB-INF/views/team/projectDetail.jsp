...
-->
	<script type="text/javascript">
		function workUn() {
			document.worklist.method="get";
			document.worklist.action="/UnConnect";
			document.worklist.submit();
		}
...
/*   	  	.open {display:block;color:green} */
	...
	#pjupdate { position:absolute;top:25%;left:40%;
...
function pjcommentDel(code) 
{ 	
	$.ajax({ type:'get',
		   url:'projectTcommectDelete',
		   data: ({cm_Code:code
			   ,m_Menu:$('#m_Menu').val()}),
		   success:function(data){
			 $('#pjcomment').html(data);
