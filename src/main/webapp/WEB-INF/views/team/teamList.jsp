...
function pOver2(obj,id){		
	var element = document.getElementById(id);
	element.style.display = 'block';	
	$(obj).removeClass('teamlist2');
	$(obj).addClass('pOver');	
}
function pOut2(obj,id){
	var element = document.getElementById(id);
	element.style.display = 'none';	
	$(obj).removeClass('pOver');
	$(obj).addClass('teamlist2');
}
</script>
</head>
<body>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="/MyMemoHamList">메모함 관리</a></li>
                            </ul>
                        </li>
                        <li class="dropdown ">
		...
		<section id="content" style="padding-bottom: 0px;">
			<div class="container">
				<div class="row" style="margin-bottom: 0px;">
					...
					<div class="col-lg-12">
						<div class="clearfix" style="clear: both;">${teamList}</div>
						<div class='row' style="margin-left: 10px;">
							<a href='/teamCreditform'><input type='button' value='팀 만들기'></a>
						</div>
						<div class="row">
							<section id="projects">
