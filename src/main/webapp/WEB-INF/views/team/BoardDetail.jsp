...
/*   	  	.open {display:block;color:green} */
	...
	#boardupdate { position:absolute;top:25%;left:40%;
...
<script type="text/javascript">
	function bocommentupdateform(code){//	
		 $('#articleView_layer').addClass('open');
		 $.ajax({ type:'post',
			   url:'boCommentUpdateForm',
			   data: ({cm_Code:code }),
			   success:function(data){
				 $('#boardupdate').html(data);				 
			}		
		});
	}
