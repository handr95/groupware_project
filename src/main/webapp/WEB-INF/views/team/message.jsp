				...
				<div class="row">
					<div class="col-md-12">
						...
						<table style="width: inherit;height: inherit;">
							...
							<tr>
								<td>
								<div style="height:250px; width: 256px;">
									<textarea style="height:250px; width: 256px; overflow:auto;"  name="msg_content"></textarea>
								</div>			
								</td>
								<td>
							...
							<tr>
								<td></td>
								<td><input type="submit" value="쪽지보내기" onclick=""></td>
							</tr>
						</table>						
						</form>
					</div>
