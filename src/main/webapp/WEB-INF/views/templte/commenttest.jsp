...
<body>
	...
	<script type="text/javascript">
		...
		function loadCommentList() {
			new ajax.xhr.Request("commentlist.jsp", "", loadCommentResult,
					'GET');
		}
		...
		function updateComment() {
			...
			new ajax.xhr.Request('commentupdate.jsp', params, updateResult,
					'POST');
		}
		...
		function confirmDeletion(commentId) {
			if (confirm("삭제하시겠습니까?")) {
				...
				new ajax.xhr.Request('commentdelete.jsp', params, removeResult,
						'POST');
			}
		}
		...
		function removeResult(req) {
			if (req.readyState == 4) {
				if (req.status == 200) {
					...
					if (code == 'success') {
						var deletedId = xmlDoc.getElementsByTagName('id').item(
								0).firstChild.nodeValue;
						var commentDiv = document.getElementById("c"
								+ deletedId);
