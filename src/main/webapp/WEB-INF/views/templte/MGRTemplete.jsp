        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><span>S</span>GW</a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="/passUpdatePage">비밀번호 변경</a></li>
                        ...
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">팀 정보 관리</a></li>                                
                                <li><a href="/boardPan_View">게시판 관리</a></li>
                                <li><a href="/memoHam_View">메모함 관리</a></li>
